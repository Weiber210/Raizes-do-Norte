    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="menuPrincipal">
            <ul class="navbar-nav me-auto">
                ...
                <li class="nav-item"><a class="nav-link" href="/Raizes-do-Norte/public/estoque/index.php">Estoque</a></li>

                <?php if (in_array($perfilMenu, ["Administrador", "Gerente", "Atendente"], true)) { ?>
                <li class="nav-item"><a class="nav-link" href="/Raizes-do-Norte/public/pagamentos/index.php">Pagamentos</a></li>
                <li class="nav-item"><a class="nav-link" href="/Raizes-do-Norte/public/fidelidade/index.php">Fidelidade</a></li>
                <?php } ?>
                ...
                <li class="nav-item"><a class="nav-link" href="/Raizes-do-Norte/public/auditoria/index.php">Auditoria</a></li>
                <?php } ?>
